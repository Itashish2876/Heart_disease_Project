...
| File | Description |
|---|---|
| `heart disease.ipynb` | Jupyter Notebook for data analysis, preprocessing, and model training |
| `Heart Disease Data.csv` | Dataset used for training the model |
| `heart_disease_app.py` | Syr app to predict heart disease based on user input |
| `Heart_Disease_Model.pkl` | Saved trained machine learning model |
| `Heart_Disease_Scaler.pkl` | Saved scaler used for feature normalization |
